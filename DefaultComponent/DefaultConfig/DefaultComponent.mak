...
BramaWjaz.o : BramaWjaz.cpp BramaWjaz.h    Default.h Odbiornik.h 
	@echo Compiling BramaWjaz.cpp
	@$(CC) $(ConfigurationCPPCompileSwitches)  -o BramaWjaz.o BramaWjaz.cpp




Odbiornik.o : Odbiornik.cpp Odbiornik.h    Default.h BramaWjaz.h 
...
Default.o : Default.cpp Default.h    BramaWjaz.h Odbiornik.h 
